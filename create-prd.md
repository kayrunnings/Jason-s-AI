...
3. **Apply standards throughout**: PRD outputs must comply with all loaded standards rules.

4. **Document compliance**: Include a Standards Compliance section in the PRD output, noting:
